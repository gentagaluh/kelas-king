...
import 'package:app_kelas_king/student/materi_detail.dart';
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>MateriDetail(datamateri: snapshot.data['data'][index], datauser: widget.datauser)));
                                    },
