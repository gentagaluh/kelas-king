...
import 'package:app_kelas_king/model/other.dart';
...
class _TugasDetailState extends State<TugasDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    print(currentUrl +
            'api/get-pengumpulantugas-pelajar/' +
    ...
    Future pengumpulanTugas(String waktu, String foto) async {
      try {
        showDialog(
            context: context,
            builder: (context) {
        ...
        var request = http.MultipartRequest(
            'POST', Uri.parse(currentUrl + 'api/pengumpulan-tugas'));
        ...
        request.fields["text"] = foto == 'no'?_submitController.text:'no';
        foto == 'no'?request.fields["foto"] = 'no':request.files
